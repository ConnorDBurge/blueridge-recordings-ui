  ...
  return (
    <>
      <div className="bg-primary">
        <div className="">
          <div className="container grid grid-cols-[repeat(auto-fit,minmax(265px,1fr))] gap-12 overflow-x-auto px-4 py-4 md:py-6">
            <Link
              href="/"
              className="group/cta flex min-w-[265px] items-center justify-center gap-6"
            >
              <TruckIcon
                width="65px"
                height="65px"
